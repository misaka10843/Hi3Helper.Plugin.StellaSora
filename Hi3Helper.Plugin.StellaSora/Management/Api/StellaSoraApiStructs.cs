...
{
    [JsonPropertyName("game_lowest_version")]  public required string GameLowestVersion  { get; set; }
    [JsonPropertyName("game_latest_version")]  public required string GameLatestVersion  { get; set; }
    [JsonPropertyName("game_latest_file_path")] public required string GameLatestFilePath { get; set; }
    [JsonPropertyName("game_start_exe_name")] public required string GameStartExeName  { get; set; }
    [JsonPropertyName("file_url")]             public required string FileUrl            { get; set; }
    [JsonPropertyName("decompression_size")]   public required string DecompressionSize  { get; set; }
}
...
{
    [JsonPropertyName("launcher_background_img")] public required string LauncherBackgroundImg { get; set; }
...
public class StellaSoraResourceData
{
    ...
    [JsonPropertyName("operations_banner_list")] public required List<StellaSoraBannerInfo> OperationsBannerList { get; set; }
}
