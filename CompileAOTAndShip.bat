@echo off
set _pluginName=Hi3Helper.Plugin.StellaSora
...
mkdir "%outputDirPath%"
cd "%projectPath%"
dotnet restore --runtime win-x64 ..\Hi3Helper.Plugin.StellaSora.sln || goto :Error
dotnet clean --configuration %configuration% --runtime win-x64 ..\Hi3Helper.Plugin.StellaSora.sln || goto :Error
